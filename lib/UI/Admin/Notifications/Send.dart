...
class _SendNotifiState extends State<SendNotifi> {
  ...
  void sendNotification(String title, String content) async {
    ...
    dio.options.headers["authorization"] =
        "Basic YjYwNWFhNGMtNGQxMi00YjNiLWJhNWUtMzE4NWI5ZjcyY2Q3";
    await dio
      ...
      child: Column(
        ...
        children: [
          TextField(
            ...
            decoration:
                InputDecoration(labelText: 'Title', border: outlineIB()),
          ),
          SizedBox(height: 16),
          TextField(
            controller: contentC,
            ...
            style: TextStyle(fontSize: 16),
            decoration:
                InputDecoration(labelText: 'Messege', border: outlineIB()),
          ),
          SizedBox(height: 16),
          Container(
            width: Get.width,
