...
class EditPostPage extends StatefulWidget {
  ...
  const EditPostPage({Key key, this.postId, this.clubImage, this.clubName, this.caption, this.imageUrl}) : super(key: key);

  @override
  _EditPostPageState createState() => _EditPostPageState(postId,clubImage,clubName,caption,imageUrl);
}
